...
//   final bool showRouteImmediately;

//   const FullMap({
//     Key? key,
//     this.residentPosition,
//     this.residentImageUrl,
//     required this.showRouteImmediately,
//   }) : super(key: key);
...
//     precacheImage(const AssetImage('assets/icons/aim_disabled.png'), context);
...
//   Future<void> _centerAndMarkResident() async {
//     if (widget.residentPosition == null) return;

//     if (!widget.showRouteImmediately) {
//       // Move camera to resident only if not showing route immediately
//       await mapboxMap?.flyTo(
//         mp.CameraOptions(
//           center: mp.Point(coordinates: widget.residentPosition!),
//           zoom: 16,
//           bearing: 0.0,
//           pitch: 0.0,
//         ),
...
//     // Load avatar + tail marker
//     final bytes = await _getImageData(widget.residentImageUrl ?? '', context);
//     if (bytes != null) {
...
// // Helper method for Map Controls (Pitch, Compass, Zoom)
//   // Helper method for Map Controls (Pitch, Compass, Zoom)
...
//         return Positioned(
//           left: screenPos.x - 130, // Center the bubble horizontally
//           top: screenPos.y - 240, // Adjusted to account for tail height
...
//                                         onPressed: _showEmergencyOrganizations,
...
//                           ),
//                         ),
//                         // 3-Dots Icon Button positioned at the top-right of the bubble
//                         Positioned(
//                           right: 10,
//                           top: 10,
...
//                                 onPressed: () => _showBubbleOptions(context),
//                               ),
//                             ),
//                           ),
//                         ),
...
//       }
//     }
//     // Handle resident marker and initial centering
//     if (widget.residentPosition != null) {
//       await _centerAndMarkResident();
//     }

//     // Draw route immediately if requested
//     if (widget.showRouteImmediately && widget.residentPosition != null) {
//       setState(() {
//         destinationPosition = widget.residentPosition;
//         _routeConfirmed = true;
//         hasDestination = true;
//       });
//       final success = await _getRouteCoordinates();
//       if (success && routeCoordinates.isNotEmpty) {
//         final points =
//             routeCoordinates.map((pos) => mp.Point(coordinates: pos)).toList();
...
//           0.0,
//         );
//         mapboxMap!.flyTo(camera, mp.MapAnimationOptions(duration: 1000));
//       }
//     }
//   }
...
//         pitch: 45.0,
//         bearing: isNavigationActive ? camera.bearing ?? 0 : 0,
...
//       mp.CameraOptions(
//         center: mp.Point(coordinates: userPosition!),
//         bearing: isNavigationActive ? bearing ?? 0 : 0,
...
//     } else {
//       mapboxMap?.flyTo(mp.CameraOptions(pitch: newPitch),
...
//     final url = Uri.parse(
//         'https://api.mapbox.com/geocoding/v5/mapbox.places/${position.lng},${position.lat}.json?access_token=${dotenv.env["MAPBOX_ACCESS_TOKEN"]!}');
//     try {
...
//                     if (item['id'].toString().contains('region')) {
//                       destinationRegionName = item['text'];
//                     }
//                     if (item['id'].toString().contains('place') ||
//                         item['id'].toString().contains('locality')) {
//                       destinationRoadName = feature['text'];
//                     }
//                   }
//                 }
//               }
//               destinationRoadName ??= features[0]['text'];
//             }
//           });
//         }
//       }
...
//     // Draw the filled path (the tail itself)
